...
contextBridge.exposeInMainWorld("trifix", {
  ...
  saveAgentToolPolicy: (payload) => ipcRenderer.invoke("app:agent-tools:save", payload),
  ...
  getLatestAgentTools: (payload) => ipcRenderer.invoke("agentTools:get-latest", payload),
  executeAgentToolRequest: (payload) => ipcRenderer.invoke("agentTools:execute-request", payload),
  approveAgentToolRequest: (payload) => ipcRenderer.invoke("agentTools:approve", payload),
  denyAgentToolRequest: (payload) => ipcRenderer.invoke("agentTools:deny", payload),
  executeApprovedAgentToolRequests: (payload) => ipcRenderer.invoke("agentTools:execute-approved", payload),
  openAgentToolFolder: (payload) => ipcRenderer.invoke("agentTools:open-folder", payload),
  ...
  getActiveWorkState: () => ipcRenderer.invoke("activeWork:get"),
  stopActiveWork: (payload) => ipcRenderer.invoke("activeWork:stop", payload),
  archiveActiveWork: (payload) => ipcRenderer.invoke("activeWork:archive", payload),
